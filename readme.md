  <head>
    ...
    <script type="text/javascript" src="js/questionHubPage.js"></script>
    <link rel="stylesheet" href="css/questionHubPage.css">
                ...
                <!-- <div class="d-flex justify-content-center"> -->
                    <div class="col-md-4 col-sm-6 col-sx-12">
                        <div class="post-module1 ">                    
                         <!-- style="background-image: linear-gradient(180deg, rgba(18, 25, 33, 0) 41.15%, rgba(18, 25, 33, 0.37) 54.8%, rgba(18, 25, 33, 0.63) 71.51%, rgba(18, 25, 33, 0.86) 85.37%, #121921 100%);"  -->
                            ...
                            <div class='post-modules' style="margin-bottom: 1px !important;">                                               
                                ...
                                <div class='post-content'>                            
                                    <h1 class='title' style="font-size: 23px; font-weight:bolder !important;">1.Backtracking Chef</h1> 
                                    <div class="sub-title" style="font-size: 15px; font-weight: lighter !important;">Submissions : N <br>
                            ...
                            <div class="row no-gutters">
                                <div class="col-12">
                                    <a style="width:100%;border-radius: 0px 0px 5px 5px;" class="btn  buttonfntr" href="#">Attempt</a>
                                </div>
                            </div>    
                        </div>
                    </div>            
                    ...
                    <div class="col-md-4 col-sm-6 col-sx-12">
                        <div class="post-module2 " >
                            ...
                            <div class='post-modules' style="margin-bottom: 1px !important;">   
                                ...
                                <div class='post-content'>
                                    <h1 class='title' style="font-size: 23px; font-weight:bolder !important;">2.Reverse The Number</h1> 
                                    <div class="sub-title" style="font-size: 15px; font-weight: lighter !important;">Submissions : N <br>
                    ...
                    <div class="col-md-4 col-sm-6 col-sx-12">
                        <div class="post-module3 " >
                            <div class='post-modules' style="margin-bottom: 1px !important;">      
                                ...
                                <div class='post-content'>
                                    <h1 class='title' style="font-size: 23px; font-weight:bolder !important;">3.Packaging Cupcakes</h1> 
                                    <div class="sub-title" style="font-size: 15px; font-weight: lighter !important;">Submissions : N <br>
                    ...
                    <div class="col-md-4 col-sm-6 col-sx-12">
                        <div class="post-module4 " >
                            <div class='post-modules' style="margin-bottom: 1px !important;">       
                                ...
                                <div class='post-content'>
                                    <h1 class='title' style="font-size: 23px; font-weight:bolder !important;">4.Smallest Numbers of Notes</h1> 
                                    <div class="sub-title" style="font-size: 15px; font-weight: lighter !important;">Submissions : N <br>
                                    ...
                                    <p class='description description4'><br>If the sum of Rs. N is input, write a program to computer smallest number of notes that will combine to give Rs. N in a currency system in which there are notes of six denominations.</p>
                                </div>
                            </div>
                            <div class="row no-gutters">
                                <div class="col-12">
                    ...
                    <div class="col-md-4 col-sm-6 col-sx-12">
                        <div class="post-module5 " >
                            <div class='post-modules' style="margin-bottom: 1px !important;">       
                                ...
                                <div class='post-content'>
                                    <h1 class='title' style="font-size: 23px; font-weight:bolder !important;">5.Coins And Triangle</h1> 
                                    <div class="sub-title" style="font-size: 15px; font-weight: lighter !important;">Submissions : N <br>
                                    ...
                                    <p class='description description5'><br>Chef brought N gold coins & decided to form a triangle using these coins.
                                        He has a unusual way of forming a triangle using gold coins.</p>
                                </div>
                            </div>
                            <div class="row no-gutters">
                                <div class="col-12">
                    ...
                    <div class="col-md-4 col-sm-6 col-sx-12">
                        <div class="post-module6 " >
                            <div class='post-modules' style="margin-bottom: 0px !important;">       
                                ...
                                <div class='post-content'>
                                    <h1 class='title' style="font-size: 23px; font-weight:bolder !important;">6.Mutated Minions</h1> 
                                    <div class="sub-title" style="font-size: 15px; font-weight: lighter !important;">Submissions : N <br>
                                        Accuracy:    
                                        <div class="progress progress-bar-striped progress-bar-animated">
                                            <div class="progress-bar progress-bar-striped progress-bar-animated " role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100" style="width: 75%;">75%</div>
...
<br> <br>
    ...
    <footer class="text-center fixed-bottom bg-light">
      <div class="container-fluid">
        <div class="footer-text">PISB <span>&copy</span></div>
      </div>
    </footer>
  </body>
  <script
